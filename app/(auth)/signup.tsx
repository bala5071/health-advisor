        ...
        <View style={[styles.form, isCompact ? styles.formCompact : null]}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputWrap}>
              ...
              />
              <Pressable onPress={() => setShowConfirmPassword((v) => !v)} style={styles.inputToggle}>
                <Ionicons name={showConfirmPassword ? 'eye-off-outline' : 'eye-outline'} size={18} color="#8E8E93" />
              </Pressable>
            </View>
          </View>
